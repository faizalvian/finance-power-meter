              ...
              <?php
                ...
                if ($getGrafik > 0) {
                  echo '<div style="margin-top:100px">
                          <h5 class="text-center">'.$_GET['bulan']. '/' .$_GET['tahun'].'(' . ($total_r + $total_s + $total_t) .' kWh)</h5>
                          <div class="text-center">
                            <p class="d-inline" style="color:#FF6384"><b>kWh R : </b></p> <b>' . $total_r .' kWh</b>
                            &nbsp;&nbsp;&nbsp;
                            <p class="d-inline" style="color:#FFCD56"><b>kWh S : </b></p> <b>' . $total_s .' kWh</b>
                            &nbsp;&nbsp;&nbsp;
                            <p class="d-inline" style="color:#36A2EB"><b>kWh T : </b></p> <b>' . $total_t .' kWh</b><br>  
                          </div>
                          <div id="report"></div>
                          <div class="col mt-1 text-center">
                            <a href="'. site_url('kwh/excelbulan/'.$bulan.'/'.$tahun.'/') .'" class="btn btn-success btn-sm">Download Excel</a>
                          </div>
                          <small class="text-center"><i>Note : Grafik diatas merupakan perhitungan kwh dari seluruh PM dalam satu bulan.</i></small>
                        </div>';
                }else{
                  echo "<center>

              ...
              <?php
                ...
                if ($getGrafik > 0) {
                  ...
                  <div style="margin-top:3%">
                    ...
                    <h5 class="text-center" style="color:#666666">Total kWh : ' . number_format($total_r + $total_s + $total_t,2,',','.') .' kWh</h5>
                    <div class="text-center">
                      <small class="d-inline" style="color:#FF6384"><b>kWh R : </b></small> <small><b>Rp. ' . number_format($total_r,2,',','.') .'</b></small>
                      &nbsp;&nbsp;&nbsp;
                      <small class="d-inline" style="color:#FFCD56"><b>kWh S : </b></small> <small><b>Rp. ' . number_format($total_s,2,',','.') .'</b></small>
                      &nbsp;&nbsp;&nbsp;
                      <small class="d-inline" style="color:#36A2EB"><b>kWh T : </b></small> <small><b>Rp. ' . number_format($total_t,2,',','.') .'</b></small><br>  
                    </div>
                    <div id="report"></div>
                    <div class="col mt-1 text-center">
                      <a href="'. site_url('kwh/excelbulan/'.$_GET['device'].'/'.$_GET['bulan'].'/'.$_GET['tahun'].'/') .'" class="btn btn-success btn-sm">Download Excel</a>
                    </div>
                    <small class="text-center"><i>Note : Grafik diatas merupakan perhitungan kwh dari 1 PM dalam satu bulan.</i></small>
                  </div>';
                }else{
                  echo "
                  <center>

        ...
        <div class="card-body">
          <div class="row">
            <div class="col">
              ...
              <?php echo "<b>Periode : </b>".$_GET['bulan']. "/" .$_GET['tahun']; ?>
            </div>
              ...
              <?php
                ...
                if ($getGrafik > 0) {
                  echo '<div style="margin-top:100px">
                          <h5 class="text-center">'.$_GET['bulan']. '/' .$_GET['tahun'].'(Rp. ' . number_format($total_r + $total_s + $total_t,2,',','.') .')</h5>
                          <div class="text-center">
                            <p class="d-inline" style="color:#FF6384"><b>Cost R : </b></p> <b>Rp. ' . number_format($total_r,2,',','.') .'</b>
                            &nbsp;&nbsp;&nbsp;
                            <p class="d-inline" style="color:#FFCD56"><b>Cost S : </b></p> <b>Rp. ' . number_format($total_s,2,',','.') .'</b>
                            &nbsp;&nbsp;&nbsp;
                            <p class="d-inline" style="color:#36A2EB"><b>Cost T : </b></p> <b>Rp. ' . number_format($total_t,2,',','.') .'</b><br>  
                          </div>
                          <div id="report"></div>
                          <div class="col mt-1 text-center">
                            <a href="'. site_url('cost/excelbulan/'.$bulan.'/'.$tahun.'/') .'" class="btn btn-success btn-sm">Download Excel</a>
                          </div>
                          <small class="text-center"><i>Note : Grafik diatas merupakan perhitungan cost dari seluruh PM dalam satu bulan.</i></small>
                        </div>';
                }else{
                  echo "<center>
